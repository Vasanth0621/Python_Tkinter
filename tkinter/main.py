...
txtdoj.grid(row=1,column=1,padx=10,pady=10,sticky="w")
...
lblContact = Label(entries_frame, text="Contact_No",font=("Calibri",16),bg="535c68",fg="white")
...
txtContact.grid(row=5,column=0,columnspan=4, padx=10,sticky="w")
def getData(event):
